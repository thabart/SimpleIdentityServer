...
{
    public static class SimpleIdentityServerFakeExtensions
    {
        public static IServiceCollection AddSimpleIdentityServerFake(this IServiceCollection serviceCollection)
        {
