...
namespace SimpleIdentityServer.Core.UnitTests.Api.Authorization
{
    public sealed class AuthorizationActionsFixture
    {
        ...
        public async Task When_Client_Require_PKCE_And_NoCodeChallenge_Is_Passed_Then_Exception_Is_Thrown()
        {
            ...
            // ACT & ASSERT
            var result = await Assert.ThrowsAsync<IdentityServerExceptionWithState>(() => _authorizationActions.GetAuthorization(authorizationParameter, null)).ConfigureAwait(false);
