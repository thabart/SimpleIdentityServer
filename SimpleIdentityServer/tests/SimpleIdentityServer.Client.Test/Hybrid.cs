...
namespace SimpleIdentityServer.Client.Test
{
    public class Hybrid
    {
        ...
        private static string LogPath = @"Logs\Hybrid";
        ...
        {
            DirectoryHelper.DropAndCreate(@"Logs\Hybrid");
            DirectoryHelper.DropAndCreate(@"Logs\Hybrid\code+id_token");
            DirectoryHelper.DropAndCreate(@"Logs\Hybrid\code+id_token+token");
            DirectoryHelper.DropAndCreate(@"Logs\Hybrid\code+token");
