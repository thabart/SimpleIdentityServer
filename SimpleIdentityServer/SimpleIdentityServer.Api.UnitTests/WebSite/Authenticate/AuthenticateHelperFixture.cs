...
namespace SimpleIdentityServer.Api.UnitTests.WebSite.Authenticate
{
    ...
    public sealed class AuthenticateHelperFixture
    {
        ...
        public void When_PromptConsent_Parameter_Is_Passed_Then_Redirect_To_ConsentScreen()
        {
            ...
            // ASSERTS
            Assert.IsTrue(actionResult.RedirectInstruction.Action == IdentityServerEndPoints.ConsentIndex);
            Assert.IsTrue(actionResult.RedirectInstruction.Parameters.Any(p => p.Name == code && p.Value == code));
        }
        ...
        public void When_Consent_Has_Already_Been_Given_Then_Redirect_To_Callback()
        {
            ...
            // ASSERTS
            Assert.IsTrue(actionResult.RedirectInstruction.ResponseMode == ResponseMode.form_post);
        }
