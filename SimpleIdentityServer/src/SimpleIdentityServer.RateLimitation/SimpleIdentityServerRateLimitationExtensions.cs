...
{
    public static class SimpleIdentityServerRateLimitationExtensions
    {
        public static IServiceCollection AddRateLimitation(this IServiceCollection serviceCollection)
        {
