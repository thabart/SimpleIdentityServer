...
{
    public interface IDisableAuthProviderOperation
    {
    ...
    internal class DisableAuthProviderOperation : IDisableAuthProviderOperation
    {
        private readonly IHttpClientFactory _httpClientFactory;

        #region Constructor

        public DisableAuthProviderOperation(IHttpClientFactory httpClientFactory)
        {
            ...
            string authorizationHeaderValue)
        {
            ...
            Uri uri = null;
            if (!Uri.TryCreate(authenticationProviderUrl + "/" + name + "/disable", UriKind.Absolute, out uri))
            {
