...
namespace SimpleIdentityServer.Uma.Core.Api.ScopeController.Actions
{
    ...
    internal class InsertScopeAction : IInsertScopeAction
    {
        ...
        private readonly IAddScopeParameterValidator _addScopeParameterValidator;

        #region Constructor

        public InsertScopeAction(
            IScopeRepository scopeRepository,
            IAddScopeParameterValidator addScopeParameterValidator)
        {
            _scopeRepository = scopeRepository;
            _addScopeParameterValidator = addScopeParameterValidator;
        }
        ...
        public bool Execute(AddScopeParameter addScopeParameter)
        {
            ...
            _addScopeParameterValidator.CheckScopeParameter(scope);
