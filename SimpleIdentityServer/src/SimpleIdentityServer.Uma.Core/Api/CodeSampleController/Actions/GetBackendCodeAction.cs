...
{
    public interface IGetBackendCodeAction
    {
        MemoryStream Execute(string languageCode);
    }

    internal class GetBackendCodeAction : IGetBackendCodeAction
    {
        private readonly ICodeProvider _codeProvider;

        #region Constructor

        public GetBackendCodeAction(ICodeProvider codeProvider)
        {
        ...
        public MemoryStream Execute(string languageCode)
        {
            ...
            return _codeProvider.GetFiles(language, Code.TypeCode.Backend);
        }
