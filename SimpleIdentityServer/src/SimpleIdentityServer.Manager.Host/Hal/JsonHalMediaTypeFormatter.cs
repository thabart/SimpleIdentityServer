...
namespace SimpleIdentityServer.Manager.Host.Hal
{
    public class JsonHalMediaTypeFormatter : JsonOutputFormatter
    {
        ...
        public JsonHalMediaTypeFormatter(IHypermediaResolver hypermediaResolver)
        {
