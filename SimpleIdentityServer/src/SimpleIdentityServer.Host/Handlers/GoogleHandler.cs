...
namespace SimpleIdentityServer.Host.Handlers
{
    internal class GoogleHandler : OAuthHandler<GoogleOptions>
    {
            ...
            OAuthTokenResponse tokens)
        {
            ...
            {
                identity.AddClaim(new Claim(Core.Jwt.Constants.StandardResourceOwnerClaimNames.GivenName, givenName, ClaimValueTypes.String, Options.ClaimsIssuer));
            }

            var familyName = GoogleHelper.GetFamilyName(payload);
            if (!string.IsNullOrEmpty(familyName))
            {
                identity.AddClaim(new Claim(Core.Jwt.Constants.StandardResourceOwnerClaimNames.FamilyName, familyName, ClaimValueTypes.String, Options.ClaimsIssuer));
            }
