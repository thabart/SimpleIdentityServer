...
namespace SimpleIdentityServer.Authentication.Middleware.Extensions
{
    public static class AuthenticationMiddlewareExtensions
    {
            ...
            this IApplicationBuilder applicationBuilder)
        {
            ...
            return applicationBuilder.UseMiddleware<AuthenticationMiddleware<AuthenticationMiddlewareOptions>>();
        }
