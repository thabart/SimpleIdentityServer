...
import { Login, About, Connections, Logs, Settings, Cache, Manage, Tools, Resources, ViewAggregate, ViewLog, OAuthClients } from './components';
...
export const routes = (<Layout>
    ...
    { !process.env.IS_MANAGE_DISABLED && (<Route exact path='/oauthclients' component={OAuthClients} />) }
