...
using SimpleIdentityServer.Configuration.IdServer.EF.Mappings;
using SimpleIdentityServer.Configuration.IdServer.EF.Models;

namespace SimpleIdentityServer.Configuration.IdServer.EF
{
    public class IdServerConfigurationDbContext : DbContext
    {
        #region Constructor

        public IdServerConfigurationDbContext(DbContextOptions<IdServerConfigurationDbContext> dbContextOptions) : base(dbContextOptions)
        {
        }
