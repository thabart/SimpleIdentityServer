...
namespace SimpleIdentityServer.Configuration.IdServer.EF.Extensions
{
    public static class SimpleIdentityServerConfigurationContextExtensions
    {
        #region Public static methods

        public static void EnsureSeedData(this IdServerConfigurationDbContext context)
        {
        ...
        private static void InsertAuthenticationProviders(IdServerConfigurationDbContext context)
        {
        ...
        private static void InsertSettings(IdServerConfigurationDbContext context)
        {
