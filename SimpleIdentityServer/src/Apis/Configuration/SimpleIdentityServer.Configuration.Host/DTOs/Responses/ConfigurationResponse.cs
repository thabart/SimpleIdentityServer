...
namespace SimpleIdentityServer.Configuration.DTOs.Responses
{
    [DataContract]
    public class ConfigurationResponse
    {
        ...
        [DataMember(Name = Constants.ConfigurationResponseNames.RepresentationsEndPoint)]
        public string RepresentationEndPoint { get; set; }
    }
}
