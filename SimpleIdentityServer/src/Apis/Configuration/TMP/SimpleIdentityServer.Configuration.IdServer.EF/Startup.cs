        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (isSqlServer)
            {
                services.AddEntityFramework()
                                .AddDbContext<IdServerConfigurationDbContext>(options => options.UseSqlServer(connectionString));
            }

            else if (isPostgre)
            {
                services.AddEntityFramework()
                                .AddDbContext<IdServerConfigurationDbContext>(options => options.UseNpgsql(connectionString));
            }
        }
