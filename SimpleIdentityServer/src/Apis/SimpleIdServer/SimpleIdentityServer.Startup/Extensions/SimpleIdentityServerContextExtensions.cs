...
namespace SimpleIdentityServer.Startup.Extensions
{
    public static class SimpleIdentityServerContextExtensions
    {
        ...
        private static void InsertClients(SimpleIdentityServerContext context)
        {
		    ...
		    // DocumentManagement website
                    new EF.Models.Client
                    {
                        ClientId = "DocumentManagementWebsite",
                        ClientName = "Document manager website",
                        ClientSecrets = new List<ClientSecret>
                        {
                            new ClientSecret
                            {
                                Id = Guid.NewGuid().ToString(),
                                Type = SecretTypes.SharedSecret,
                                Value = "DocumentManagementWebsite"
                            }
                        },
                        TokenEndPointAuthMethod = TokenEndPointAuthenticationMethods.client_secret_basic,
                        LogoUri = "http://img.over-blog-kiwi.com/1/47/73/14/20150513/ob_06dc4f_chiot-shiba-inu-a-vendre-prix-2015.jpg",
                        ...
                        IdTokenSignedResponseAlg = "RS256",
                        ApplicationType = ApplicationTypes.web,
                        RedirectionUrls = "http://localhost:64951/callback",
                        PostLogoutRedirectUris = "http://localhost:64951/end_session",
                        UpdateDateTime = DateTime.UtcNow,
                        CreateDateTime = DateTime.UtcNow
                    },
                    // Resource manager website.
                    new EF.Models.Client
                    {
                        ...
                        IdTokenSignedResponseAlg = "RS256",
                        ApplicationType = ApplicationTypes.web,
                        RedirectionUrls = "http://localhost:61000/callback",
                        PostLogoutRedirectUris = "http://localhost:61000/end_session",
                        UpdateDateTime = DateTime.UtcNow,
                        CreateDateTime = DateTime.UtcNow
                    },
