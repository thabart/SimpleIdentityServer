...
namespace SimpleIdentityServer.AccountFilter.Basic.EF.SqlServer
{
    public class AccountFilterSqlServerModule : IModule
    {
        ...
        private void HandleMvcAdded(object sender, System.EventArgs e)
        {
            ...
            AspPipelineContext.Instance().ConfigureServiceContext.Services.AddBasicAccountFilterSqlServerEF(connectionString);
        }
    }
}
