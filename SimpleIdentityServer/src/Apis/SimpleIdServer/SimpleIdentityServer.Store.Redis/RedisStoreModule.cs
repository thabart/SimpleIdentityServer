...
namespace SimpleIdentityServer.Store.Redis
{
    ...
    {
        private const string _redisStorageConfiguration = "RedisStorageConfiguration";
        private const string _redisStorageInstanceName = "RedisStorageInstanceName";
        private const string _redisStoragePort = "RedisStoragePort";
