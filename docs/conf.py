...
latex_documents = [
  ('index', 'SimpleIdServerdoc.tex', u'Simple Identity Server Documentation',
   u'Thierry Habart', 'manual'),
]
...
man_pages = [
    ('index', 'simpleidserver', u'Simple Identity Server Documentation',
     [u'Habart Thierry'], 1)
]
...
texinfo_documents = [
  ('index', 'SimpleIdServer', u'Simple Identity Server Documentation',
   u'Habart Thierry', 'SimpleIdServer', 'One line description of project.',
   'Miscellaneous'),
]
